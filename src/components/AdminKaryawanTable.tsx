                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="border-b border-slate-200 bg-slate-50">
                            ...
                            <th className="px-4 py-3 text-left font-semibold text-slate-700">Perusahaan</th>
                        ...
                        {loading ? (
                            ...
                            data.map((karyawan) => (
                                <tr key={karyawan.id} className="border-b border-slate-200 hover:bg-slate-50 transition">
                                    ...
                                    <td className="px-4 py-3 text-slate-600">{karyawan.perusahaan}</td>
                                    <td className="px-4 py-3 text-slate-600">{karyawan.kontrakSekarang}</td>
                                    <td className="px-4 py-3 text-slate-600">
                                        {karyawan.sisaWaktuKontrak > 0
                                            ? `${karyawan.sisaWaktuKontrak} minggu`
                                            : '-'}
                                    </td>
