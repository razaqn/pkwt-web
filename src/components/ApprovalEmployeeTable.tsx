...
import type { ApprovalEmployee, PaginationState } from '../types/approvalTypes';
...
export default function ApprovalEmployeeTable({
    employees,
    pagination,
    onPageChange,
    itemsPerPage = 10
}: ApprovalEmployeeTableProps) {
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Jumlah Kontrak Sebelumnya</th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                <td colSpan={4} className="px-6 py-12 text-center text-sm text-gray-500">
                                    <div className="flex flex-col items-center justify-center gap-2">
                                        ...
                                        <p>Belum ada data karyawan yang terkait</p>
                                    </div>
                                </td>
                            </tr>
                        )}
