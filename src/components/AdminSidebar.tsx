...
import { LayoutDashboard, Users, FileText, FileCheck, FilePlus, Settings, Image, Folder, LogOut, BookTemplate, Shield, FileSpreadsheet } from 'lucide-react';
        ...
        <>
            ...
            <aside className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 left-0 z-40 w-64 md:w-56 transform transition bg-[#48A32A] text-slate-100 flex flex-col`}>
                ...
                <nav className="px-3 py-4 space-y-2 flex-1 overflow-y-auto">
                    ...
                    <NavLink to="/admin/list-bpjs" className={({ isActive }) => `flex items-start gap-3 rounded-xl px-3 py-3 ${isActive ? 'bg-white/10 ring-1 ring-white/15 shadow-inner' : 'hover:bg-white/5'} transition`}>
                        <span className="mt-0.5 text-white/90">
                            <FileSpreadsheet className="h-5 w-5" />
                        </span>
                        <span className="flex-1">
                            <div className="text-sm font-medium">Data BPJS</div>
                            <div className="text-[11px] text-white/70">Monitoring data BPJS</div>
                        </span>
                    </NavLink>
                    ...
                    <NavLink to="/admin/create-contract" className={({ isActive }) => `flex items-start gap-3 rounded-xl px-3 py-3 ${isActive ? 'bg-white/10 ring-1 ring-white/15 shadow-inner' : 'hover:bg-white/5'} transition`}>
                        <span className="mt-0.5 text-white/90">
                            <FilePlus className="h-5 w-5" />
                        </span>
                        <span className="flex-1">
                            <div className="text-sm font-medium">Buat Kontrak</div>
                            <div className="text-[11px] text-white/70">Buat PKWT/PKWTT mandiri</div>
                        </span>
                    </NavLink>
                    ...
                    <NavLink to="/admin/templates" className={({ isActive }) => `flex items-start gap-3 rounded-xl px-3 py-3 ${isActive ? 'bg-white/10 ring-1 ring-white/15 shadow-inner' : 'hover:bg-white/5'} transition`}>
                        <span className="mt-0.5 text-white/90">
                            <Folder className="h-5 w-5" />
                        </span>
                        <span className="flex-1">
                            <div className="text-sm font-medium">Templates</div>
                            <div className="text-[11px] text-white/70">Upload & tampilkan file</div>
                        </span>
                    </NavLink>

                    <NavLink to="/admin/document-templates" className={({ isActive }) => `flex items-start gap-3 rounded-xl px-3 py-3 ${isActive ? 'bg-white/10 ring-1 ring-white/15 shadow-inner' : 'hover:bg-white/5'} transition`}>
                        <span className="mt-0.5 text-white/90">
                            <BookTemplate className="h-5 w-5" />
                        </span>
                        <span className="flex-1">
                            <div className="text-sm font-medium">Dokumen Resmi</div>
                            <div className="text-[11px] text-white/70">Editor template dokumen disnaker</div>
                        </span>
                    </NavLink>
                </nav>
