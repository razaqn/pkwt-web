...
import { AlertCircle, ArrowLeft, Building2, Globe, Info, MapPin, Phone, RotateCcw } from 'lucide-react';
...
export default function DetailCompany() {
        ...
        return (
            <div className="flex items-start gap-3 rounded-xl border border-red-200 bg-red-50 px-5 py-4 shadow-sm">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-sm text-red-700 mt-1">ID perusahaan tidak ditemukan.</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="flex items-center justify-center py-12">
                <div className="flex flex-col items-center gap-3 text-slate-600">
                    ...
                    <span className="text-sm">Memuat detail perusahaan...</span>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <h1 className="mt-1 text-2xl font-bold tracking-tight text-slate-900">Detail Perusahaan</h1>
                    <p className="mt-1 text-sm text-slate-600">Informasi lengkap tentang perusahaan</p>
                </div>
            ...
            <div className="space-y-6">
                ...
                <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
                    <div className="border-b border-slate-200 bg-gradient-to-r from-primary/10 via-white to-secondary/25 px-5 py-4">
                        ...
                        <p className="mt-1 text-sm text-slate-600">Kami tidak menemukan data perusahaan untuk ID ini.</p>
                    </div>
                    <div className="px-5">
                        <EmptyState
                            title="Data perusahaan tidak ditemukan"
                            description="Coba refresh. Jika masih tidak muncul, pastikan ID perusahaan valid."
                        />
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Informasi Dasar Section (match company ProfilePerusahaan layout) */}
                            ...
                            <div>
                                ...
                                <div className="mt-2 grid grid-cols-3 gap-2">
                                    <div className="rounded-lg bg-primary/10 px-2 py-2 text-center ring-1 ring-inset ring-primary/15">
                                        ...
                                        <p className="text-lg font-bold text-primary">{profile.active_contracts_pkwt}</p>
                                    </div>
                                    <div className="rounded-lg bg-secondary/30 px-2 py-2 text-center ring-1 ring-inset ring-secondary/40">
                                        ...
                                        <p className="text-lg font-bold text-slate-900">{profile.active_contracts_pkwtt}</p>
                                    </div>
