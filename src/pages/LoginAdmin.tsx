        ...
        <div className="mt-6 mx-auto w-full max-w-md rounded-2xl bg-white shadow-xl border border-slate-200">
          <div className="p-6">
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <button type="submit" disabled={loading} className="w-full h-10 rounded-md bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-500 disabled:opacity-50">{loading ? 'Memproses...' : 'Masuk Admin'}</button>
            </form>
          </div>
        </div>
      </div>
