...
// ============================================================================
// These interfaces define the data structure returned from the backend API.
// Once the backend provides the endpoint, update the component to use these types.
// ============================================================================

interface InformasiPribadi {
    nik: string;
    alamat: string;
...
interface RiwayatKontrak {
    id: string;
    judul: string;
    tanggalMulai: string; // Formatted in Indonesian date format
    durasi: string; // e.g., "12 bulan" or "Tetap"
}

export interface DetailKaryawanData {
    id: string;
    namaLengkap: string;
    informasiPribadi: InformasiPribadi;
    informasiPekerjaan: InformasiPekerjaan;
                ...
                <div className="p-6">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label className="text-sm font-medium text-slate-600">Kelamin</label>
                                    <p className="mt-2 text-slate-900">{data?.gender || '-'}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-slate-600">Jabatan</label>
                                    <p className="mt-2 text-slate-900">{data?.position || '-'}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-slate-600">Alamat (Kelurahan)</label>
