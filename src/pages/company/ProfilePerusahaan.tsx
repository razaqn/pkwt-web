        ...
        return (
            <div className="space-y-6">
                <div>
                    ...
                    <p className="mt-1 text-slate-600">Informasi lengkap tentang perusahaan Anda</p>
                </div>
    ...
    if (!profile) {
        return (
            <div className="rounded-lg border bg-slate-50 p-8 text-center">
                <p className="text-slate-600">Tidak ada data profil perusahaan</p>
            </div>
        );
    }
                            ...
                            <div>
                                ...
                                <div className="mt-2 grid grid-cols-3 gap-2">
                                    <div className="rounded-md bg-blue-50 px-2 py-2 text-center">
                                        ...
                                        <p className="text-lg font-bold text-blue-900">{profile.activeContractsPKWT}</p>
                                    </div>
                                    <div className="rounded-md bg-green-50 px-2 py-2 text-center">
                                        <p className="text-xs text-green-700">PKWTT</p>
                                        <p className="text-lg font-bold text-green-900">{profile.activeContractsPKWTT}</p>
                                    </div>
